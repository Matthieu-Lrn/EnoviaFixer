...
If Len(Trim$(kbePathFile)) = 0 Then
    kbePathFile = "\\aero\mtlplm\catia\V5_KBE_Tools\Production\00_KBE_Env\06_KBE_CATScript\01_MACROS\02_BA_GCC\08_PATH_FILES\BA_COMMON_KBE_PATH.txt"
End If

'Initialize
sKBEPathFile = kbePathFile
sMacroMode = "PROD"
sActiveToolbarPath = toolbarPath
...
sFinishType = oPathDict("Finish Type")
sPLTemplateFile = oPathDict("PL Template")
sSDDTemplateFile = oPathDict("SDD Template")
sIDLCompareFile = oPathDict("IDL Compare File")
sSoftMaterialList = oPathDict("Soft Material")
sColorCodeDashNumber = oPathDict("Color Code DashNumber")
sColorCodePartExclusionList = oPathDict("Color Code Part Exclusion")
sColorCodeList = oPathDict("Color Code List")
sWebServiceAccessToolName = oPathDict("WebServiceAccessToolName")
...
mdlPVRSync.bLangflowAutomated = True
mdlPVRSync.sLangflowProject = projectNumber
mdlPVRSync.bLangflowSyncFromBSF = (UCase$(Trim$(syncFromBSF)) = "TRUE")
mdlPVRSync.sLangflowCIOption = ciOption
mdlPVRSync.sLangflowNonCIOption = nonCIOption

Call mdlPVRSync.PVRSyncMain

mdlPVRSync.bLangflowAutomated = False
mdlPVRSync.sLangflowProject = ""
mdlPVRSync.bLangflowSyncFromBSF = False
mdlPVRSync.sLangflowCIOption = ""
mdlPVRSync.sLangflowNonCIOption = ""
