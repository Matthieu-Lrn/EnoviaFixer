Attribute VB_Name = "mdlParseJSON"
Option Explicit
...
Public Sub ParseJSON(ByVal sSample As String, vJson As Variant, sState As String)
...
Private Function Serialize(vJson As Variant) As String
...
Private Function ToString(vJson As Variant) As String
...
Private Sub ToArray(vJson As Variant, aRows() As Variant, aHeader() As Variant)
