...
Do
    ...
    DoEvents
    Sleep 250
    If Abs(Timer - dTimer) > 5 Then Exit Do
Loop
...
WebServiceAccessTool.UsedbyApplication = "LangflowSaveFileBase"

Set oPasswordMgr = New clsPasswordMgr
oPasswordMgr.ResetPassword

mdlSave3DStructure.sLangflowDestinationFolder = exportFolder
Call mdlSave3DStructure.StartProcess
mdlSave3DStructure.sLangflowDestinationFolder = ""
